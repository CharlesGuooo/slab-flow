      ...
      <div className="text-center max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-left hover:shadow-md transition-shadow">
            ...
            <p className="mt-2 text-xs text-gray-400 text-center">admin@slabflow.local / admin123</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-left hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Tenant Site</h3>
                <p className="text-sm text-gray-500">Test Company Portal</p>
              </div>
            </div>
            <Link
              href="/en"
            ...
            >
              Enter Test Company Site
            </Link>
            <p className="mt-2 text-xs text-gray-400 text-center">Browse stones, chat with AI, etc.</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-left hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Manage Test Company</p>
              </div>
            </div>
            <Link
              href="/admin/login"
            ...
            <p className="mt-2 text-xs text-gray-400 text-center">admin@test-company.localhost / tenant123</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-left hover:shadow-md transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Customer access</p>
              </div>
            </div>
            <Link
              href="/en/login"
              className="block w-full text-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors text-sm"
            >
              Login as Client
            </Link>
            <p className="mt-2 text-xs text-gray-400 text-center">john.smith@email.com / 123456</p>
          </div>
        </div>
        ...
        <p className="text-xs text-gray-400">
          Development Mode • All test accounts available
        </p>
      </div>
    </main>
  );
